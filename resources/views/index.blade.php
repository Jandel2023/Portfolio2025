        				...
        				<aside class="f_widget news_widget">
        					...
        					<div id="mc_embed_signup">
                                {{-- <form target="_blank" action="" method="get">
                                	<div class="input-group d-flex flex-row">
                                        <input name="EMAIL" placeholder="Enter email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Address '" type="email" required>
                            ...
                            <div id="mc_embed_shell">
                                ...
                                <form action="https://space.us16.list-manage.com/subscribe/post?u=9baa2c5c90016b5bd148cc2f7&amp;id=77dc1d2cf8&amp;f_id=00ca91e1f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
                                    <div id="mc_embed_signup_scroll"><h2>Stay updated with our latest trends</h2>
