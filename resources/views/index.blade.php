					...
					<div class="container box_1620">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
                                <li class="nav-item"><a class="nav-link active" href="#home" style="position: relative; color: #007BFF; text-decoration: none;">Home</a></li>
                                <li class="nav-item"><a class="nav-link" href="#about" style="position: relative; text-decoration: none;">About</a></li>
                                <li class="nav-item"><a class="nav-link" href="#services" style="position: relative; text-decoration: none;">Services</a></li>
                                <li class="nav-item"><a class="nav-link" href="#projects" style="position: relative; text-decoration: none;">Projects</a></li>
                                <li class="nav-item"><a class="nav-link" href="#blogs" style="position: relative; text-decoration: none;">Blog</a></li>
                                <li class="nav-item"><a class="nav-link" id="contactBtn" style="position: relative; text-decoration: none; cursor: pointer;">Contact</a></li>
							</ul>
						</div>
					</div>
            	</nav>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="banner_content">
								...
								<a class="banner_btn" href="#" id="contactBtn1" data-aos="fade-left" data-aos-duration="1000">Contact Me</a>
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="container py-2">
                ...
                <article class="postcard light blue" data-aos="fade-up" data-aos-duration="1000">
                    <a class="postcard__img_link" href="#">
                        <img class="postcard__img" src="{{ asset(Storage::url($project->image)) }}" alt="Image Title" />
                    </a>
                    <div class="postcard__text t-dark">
                        <h1 class="postcard__title blue"><a href={{ $project->link }} target="_blank">{{ $project->name }}</a></h1>
                        <div class="postcard__subtitle small">
                            <time datetime="2020-05-25 12:00:00">
                                <i class="fas fa-calendar-alt mr-2"></i>{{ \Carbon\Carbon::parse($project->start_date)->format('F j, Y') }}
                            </time>
                        </div>
                        ...
                        <ul class="postcard__tagbox">
                            ...
                            <li class="tag__item">
                                <a href="{{ $project->code }}" target="_blank" style="text-decoration: none; color: inherit;">
						...
						<div class="item">
                            <div class="testi_item text-center">
                                <div class="container d-flex justify-content-center mb-3">
                                    <img src="{{asset(Storage::url($testimonial->image))  }}" alt="{{ $testimonial->name }}" style="width: 100px; height: 100px; object-fit: cover; border-radius: 100%;">
                                </div>
                            ...
                            <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1000">
                                <div class="l_blog_item">
                                    <div class="l_blog_img">
                                        <img class="img-fluid" src={{ asset(Storage::url($blog->featured_image))  }} alt="">
                                    </div>
        		...
        		<div class="row footer_inner">
        			<div class="col-lg-5 col-sm-6" data-aos="fade-right" data-aos-duration="1000">
        				<aside class="f_widget ab_widget">
        					...
        					<p>Do you want to be even more successful? Learn to love learning and growth. The more effort you put into improving your skills, the more doors you’ll see swing open—opportunities you never even noticed before will start popping up everywhere, and challenges that once felt huge will shrink into welcome chances to level‑up.</p>
        					<p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | By Jandel Lopez</p>
        				</aside>
        			</div>
        			<div class="col-lg-5 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
        				<aside class="f_widget news_widget">
                            ...
                            <div id="mc_embed_shell">
                                ...
                                <style type="text/css">
                                        #mc_embed_signup{background:#000410; false;clear:left; font:14px Helvetica,Arial,sans-serif; width: auto;}
                                </style>
                                {{-- <div id="mc_embed_signup"> --}}
                                <form action="https://space.us16.list-manage.com/subscribe/post?u=9baa2c5c90016b5bd148cc2f7&amp;id=77dc1d2cf8&amp;f_id=00ca91e1f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
                                    <div id="mc_embed_signup_scroll"><h2>Stay updated with my latest trends</h2>
                                    ...
                                    <div aria-hidden="true" style="position: absolute; left: -5000px;">
                                        ...
                                        <input type="text" name="b_9baa2c5c90016b5bd148cc2f7_77dc1d2cf8" tabindex="-1" value="">
                                    </div>
        			...
        			<div class="col-lg-2" data-aos="fade-left" data-aos-duration="1000">
        				<aside class="f_widget social_widget">
        					...
        					<ul class="list">
        						<li>
                                    <a href="https://web.facebook.com/demski.chu2xbrothers" target="_blank" title="Visit my Facebook">
                                        <i class="fa fa-facebook"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/jandel-lopez-85a6272ba/" target="_blank" title="View my LinkedIn">
                                        <i class="fa-solid fa-tent-arrow-down-to-line"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/demski.21/" target="_blank" title="Follow me on Instagram">
                                        <i class="fa-brands fa-square-instagram"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.youtube.com/@jandellopez2120" target="_blank" title="Subscribe to my YouTube">
